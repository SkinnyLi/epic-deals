...
var origNum=parseFloat(orig.replace(/[^0-9.]/g,''))||0;
var discNum=parseFloat(discP.replace(/[^0-9.]/g,''))||0;
...
info.originalPriceCNY=origNum>0?'约¥'+Math.round(origNum*R):'';
info.discountPriceCNY=discNum>0?'约¥'+Math.round(discNum*R):'';
